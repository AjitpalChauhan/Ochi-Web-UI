...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen p-20 ">
      <div className='w-1/2 flex flex-col justify-between h-full font-["Founders Grotesk"]'>
        <div className="heading">
          <h1 className="text-[5vw] font-bold uppercase leading-none -mb-4">
            Eye-
          </h1>
          <h1 className="text-[5vw] font-bold leading-none -mb-10">
            Opening
          </h1>
        </div>
        <div>
      ...
      <h1 className="text-[5vw] font-bold uppercase leading-none -mb-4 ">
          ...
          <div className='dets font-["Neue_Montreal"] mt-10'>
            ...
            <a className="font-light block text-lg underline" href="#">Facebook</a>
            <a className="font-light block text-lg underline" href="#">Instagram</a>
            <a className="font-light block text-lg underline" href="#">Behance</a>
            <a className="font-light block text-lg underline" href="#">LinkedIn</a>
          </div>
          <div className='dets font-["Neue_Montreal"] mt-10'>
            <h1 className="mb-4">L:</h1>
            <a className="font-light block text-lg underline" href="#">202-1965 W 4th Ave <br></br>
            Vancouver, Canada</a>
            <a className="font-light block text-lg underline mt-4" href="#">30 Chukarina St <br></br>
            Lviv, Ukraine</a>
          </div>
      </div>
    </div>
